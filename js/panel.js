...
<div class="left-strudel-panel" id="left-strudel-panel">
    ...
    <div class="ls-arc" aria-label="Auto build-up">
        ...
        <p class="ls-arc-hint">Air → Drone → Motion → Bass → Beat → Melody → Drone ↓ → Air ↓. Each line enters "from" a phase and stays; the fade-out drops the dense layers and ends on the drone bed.</p>
        <div class="ls-phases" aria-label="Build-up phase">
